...
var ExamWrapper = function ExamWrapper(_ref) {
  ...
  var sequence = props.sequence,
    ...
    originalUserIsStaff = props.originalUserIsStaff,
    canAccessProctoredExams = props.canAccessProctoredExams;
    ...
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return dispatch((0, _data.getExamAttemptsData)(courseId, sequence.id));
          case 2:
            _context.next = 4;
            return dispatch((0, _data.getAllowProctoringOptOut)(sequence.allowProctoringOptOut));
          case 4:
            _context.next = 6;
            return dispatch((0, _data.checkExamEntry)());
          case 6:
          case "end":
